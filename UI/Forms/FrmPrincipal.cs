...
namespace CarniceriaPOS.UI.Forms
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void AplicarEstilos()
        {
            ...
            Text = "Sistema CarnicerÃƒÆ’Ã‚Â­a - " + nombreUsuario;
        ...
        private void AbrirFormularioEnContenido(Form formulario, string titulo)
        {
            ...
            catch (Exception ex)
            {
                ...
                pnlContent.ResumeLayout(true);
                MessageBox.Show($"No se puede abrir el mÃƒÆ’Ã‚Â³dulo: {titulo}\n\n{ex.Message}",
        ...
        private void ValidarYAbrirFormulario(Control boton, string modulo, Form formulario, string titulo)
        {
            try
            {
                ...
                if (!boton.Enabled)
                {
                    MessageBox.Show("No tiene permiso para acceder a este mÃƒÆ’Ã‚Â³dulo.", "Acceso Denegado");
                    return;
                }
